...
import {
  ...
  HeartHandshake, Home, Info, LogOut, MapPin, Minus, Phone, Plus, Search,
...
export default function Page(){
  ...
  return <main className="app-shell">
    <aside className="app-sidebar">
      ...
      <nav className="app-nav"><NavButton active={view==='home'} icon={<Home/>} label="Home" onClick={()=>setView('home')}/><NavLink href="/payments" icon={<WalletCards/>} label="Payments"/><NavLink href="/schools" icon={<Building2/>} label="Schools" badge={memberships.length||undefined}/><NavButton active={view==='projects'} icon={<Trophy/>} label="Projects" badge={myProjects.length||undefined} onClick={()=>setView('projects')}/><NavLink href="/about" icon={<Info/>} label="About"/><NavButton active={view==='profile'} icon={<CircleUserRound/>} label="Profile" onClick={()=>setView('profile')}/></nav>
